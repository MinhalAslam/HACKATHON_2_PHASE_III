          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{pendingTasks.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{completedTasks.length}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-12 border border-slate-200 dark:border-slate-700 text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-6">
              Create your first task or ask the AI assistant to help!
            </p>
            <button
              onClick={() => setShowCreateForm(true)}
